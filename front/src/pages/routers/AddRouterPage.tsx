        ...
        <div className="grid-cols-1 mb-12 grid gap-12 px-4 lg:grid-cols-2 xl:grid-cols-1 justify-items-center">
            <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 lg:p-0 p-7">
                    <div className="mb-4 flex flex-col gap-6"> 
                        ...
                        <Input value={router.routerPassword} required type="password" size="lg" label="Parola" onChange={(e) => {setRouter({...router, routerPassword: e.target.value})}}/>
                        ...
                        <Input value={router.routerPhone} required size="lg" label="Numar de telefon" onChange={(e) => { setRouter({...router, routerPhone: e.target.value})}}/>
                        
                        <GenericDropdown array={["Router dispozitive", "Router notificari"]} defaultValue={"Selecteaza tip comunicatie"} onChange={(e) => {onChangeRouterType(e)}} />
                    ...
                    <div className="mb-4 flex flex-col gap-6"> 
                      <button onClick={createRouter} className="buttonRouterAdd">
                      Inrolare
                      </button>
                    </div>
            </form>
