        ...
        <div className="grid-cols-1 mb-12 grid gap-12 px-4 lg:grid-cols-2 xl:grid-cols-1 justify-items-center">
            <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 lg:p-0 p-7">
                    <div className="mb-4 flex flex-col gap-6"> 
                        ...
                        <Input maxLength={10} value={ (device.deviceMsisdn.length === 13) ?  device.deviceMsisdn.substring(3, device.deviceMsisdn.length) : device.deviceMsisdn} required size="lg" label="Phone No" onChange={(e) => { setDevice({...device, devicePhone: e.target.value, deviceMsisdn: e.target.value})}}/>  
                    ...
                    <div className="mb-4 flex flex-col gap-6">
                        <Input value={devicePassword.oldPassword} required type="password" size="lg" label="Old password" onChange={(e) => {setDevicePassword({...devicePassword, oldPassword: e.target.value})}}/>
                        <Input value={devicePassword.password} required type="password" size="lg" label="New password" onChange={(e) => {setDevicePassword({...devicePassword, password: e.target.value})}}/>
                        <Input value={repeatNewPassword} required type="password" size="lg" label="Repeat new password" onChange={(e) => {setRepeatNewPassword(e.target.value)}} />                            
