        ...
        <div className="grid-cols-1 mb-12 grid gap-12 px-4 lg:grid-cols-2 xl:grid-cols-1 justify-items-center">
            <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 lg:p-0 p-7">
                    <div className="mb-4 flex flex-col gap-6"> 
                        ...
                        <GenericDropdown array={roles!.map(role => role.name)} defaultValue={"Selecteaza rol"} onChange={(e) => {setUser({...user, role: e})}} />
                    </div>
                    {/* <Button onClick={createUser} className="mt-6 bg-gradient-to-r from-indigo-300 to-indigo-950 bg-cover" fullWidth>Adauga</Button> */}
