...
<form className="flex flex-col gap-5 pb-5">
  <div className="relative w-full">
    ...
    <input type="text" name="name" className="h-10 px-2 border border-black rounded" />
  </div>

  <div className="relative w-full">
    <label htmlFor="email" className="absolute top-[-12px] left-2.5 bg-white px-2.5 text-[14px]">E-Mail</label>
    <input type="email" name="email" className="h-10 px-2 border border-black rounded" />
  </div>

  <div className="relative w-full">
    <label htmlFor="text" className="absolute top-[-12px] left-2.5 bg-white px-2.5 text-[14px]">Text</label>
    <textarea name="text" rows={5} className="px-2 border border-black rounded"></textarea>
  </div>
</form>
