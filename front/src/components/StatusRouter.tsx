    ...
    return (
        ...
        <div>
              {/* <button
                ...
                className={" relative h-10 w-full overflow-hidden rounded-xl  bg-center text-white font-bold" 
                + (entity?.content?.filter( x => x.status === "Unreachable").length === 0 ? " bg-gradient-to-r from-indigo-400 to-indigo-950 bg-cover" : " bg-gradient-to-r from-red-500 to-indigo-750 bg-cover")}
              >
