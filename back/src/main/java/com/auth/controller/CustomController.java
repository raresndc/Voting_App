...
import com.app.controller.dao.EmailRequest;
...
public class CustomController {
	...
	@ResponseBody
	public ResponseEntity<ResponseUser> forgotPassword(@CookieValue(name = "username", defaultValue = "") String username,
			@RequestBody RequestUser req,
			HttpServletRequest request) {
...
//			CredentialsVerification.checkPasswordConstrains(req.getNewPassword());
			...
			accountsService.forgotPassword(req.getUsername());
	...
	@RequestMapping(method = RequestMethod.POST, value = "/changePasswordRandom")
	@ResponseBody
	public ResponseEntity<ResponseUser> changePasswordRandom(@CookieValue(name = "username", defaultValue = "") String username,
			@RequestBody RequestUser req,
			HttpServletRequest request) {
		...
		try {
			...
			accountsService.changePasswordRandom(req.getUsername(),
					req.getOldPassword(),
					req.getNewPassword());
	...
	@RequestMapping(method = RequestMethod.POST, value = "/changeMail")
	@ResponseBody
	public ResponseEntity<Object> changeEmail(@CookieValue(name = "access_token", defaultValue = "") String access_token,
			@CookieValue(name = "refresh_token", defaultValue = "") String refresh_token,
			@CookieValue(name = "username", defaultValue = "") String username,
			@RequestBody RequestUser req,
			HttpServletRequest request) {
		...
		try {
			...
			accountsService.changeMail(username,
					req.getEmail());
	...
	@RequestMapping(method = RequestMethod.POST, value = "/changeFullAdress")
	@ResponseBody
	public ResponseEntity<Object> changeFullAdress(@CookieValue(name = "access_token", defaultValue = "") String access_token,
			@CookieValue(name = "refresh_token", defaultValue = "") String refresh_token,
			@CookieValue(name = "username", defaultValue = "") String username,
			@RequestBody RequestUser req,
			HttpServletRequest request) {
		...
		try {
			...
			accountsService.changeFullAdress(username,
					req.getTara(), req.getJudet(), req.getLocalitate(), req.getAdresa());
